    ...
    <div className="">
      <div className="relative overflow-hidden bg-slate-50 border-b border-slate-100">
        <div className="w-2/3 mx-auto flex flex-col justify-center items-center py-10 lg:py-16 relative z-10">
          <h2 className="text-3xl md:text-5xl lg:text-5xl font-inter font-black tracking-wide text-slate-900 text-center leading-tight">
      ...
      <div className="w-2/3 mx-auto py-16 flex flex-col gap-10">
        {/* Section 1 */}
        <section>
          <h3 className="text-xl font-bold font-inter text-slate-900 mb-4 tracking-wide">
          ...
          <p className="text-base text-slate-700 font-inter leading-relaxed">
            ...
            trading advice, or any form of financial solicitation. BITSS does not
            recommend that any cryptocurrency, token, or smart contract protocol
            should be purchased, sold, or held by you. Always conduct your own
            thorough due diligence and consult a licensed financial advisor before
        ...
        <section>
          ...
          <p className="text-base text-slate-700 font-inter leading-relaxed mb-4">
            ...
            However, all content, scores, and services are provided on an "as is"
          ...
          <p className="text-base text-slate-700 font-inter leading-relaxed">
            ...
            reliance on our content, reports, or tools is solely at your own
            risk and discretion.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-base text-slate-700 font-inter leading-relaxed">
            ...
            constitute an endorsement, warranty, or guarantee by BITSS. We are
            not responsible for the operational safety, code integrity, or
            financial conduct of external third-party platforms.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 mb-4 space-y-2 text-base text-slate-700 font-inter">
            <li>
          ...
          <p className="text-base font-inter leading-relaxed font-semibold text-rose-600">
        ...
        <section>
          ...
          <p className="text-base text-slate-700 font-inter leading-relaxed">
            ...
            <a href="mailto:security@bitss.one" className="text-primary hover:underline font-semibold">
              security@bitss.one
            </a>
          </p>
        </section>
