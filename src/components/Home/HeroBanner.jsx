  ...
  return (
    <>
      <div
        ...
        className="relative h-screen w-full bg-center bg-cover overflow-hidden">
        ...
        <Container>
          <div className="relative z-20 flex flex-col md:flex-row gap-20 md:gap-0 p-5 md:px-10 md:py-10">
            <div className="flex-1">
              ...
              <div className="flex justify-between mt-10 text-white bg-slate-950/80 rounded-lg py-6 px-8">
