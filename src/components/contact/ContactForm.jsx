    ...
    <section className="relative py-16 sm:py-20 bg-slate-50 dark:bg-transparent overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
        ...
        <div className="text-center mb-12">
          <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/5 border border-red-100 text-primary text-[11px] font-semibold tracking-wide uppercase">
            <span className="w-1.5 h-1.5 rounded-full bg-primary animate-pulse" />
            Send a Message
          </span>
          <h2
            className="font-black text-slate-900 dark:text-white mt-4 mb-3 leading-none"
            style={{
